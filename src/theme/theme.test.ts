...
test('exposes the adaptive workspace design tokens', () => {
  expect(theme.workspace).toEqual({
    canvas: '#F6F6F3',
    canvasCool: '#F5F7FC',
    navigation: '#0D1838',
...
test('has the expected typography', () => {
...
test('has the expected components', () => {
