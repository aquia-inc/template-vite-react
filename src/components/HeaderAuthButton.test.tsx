...
test('renders empty container when jwtToken is null', () => {
...
test('renders login button when jwtToken is undefined', () => {
...
test('renders logout button when jwtToken is defined', () => {
