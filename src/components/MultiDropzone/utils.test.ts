...
describe('getUploadStatus', () => {
  test('returns ERROR if error is present', () => {
    expect(getUploadStatus(0, 'error')).toEqual(UploadStatus.ERROR)
  })

  test('returns UPLOADING if progress is less than 100', () => {
    expect(getUploadStatus(50)).toEqual(UploadStatus.UPLOADING)
  })

  test('returns COMPLETE if progress is 100 and no error', () => {
...
describe('getErrorMessage', () => {
  test('returns custom error message for invalid file type', () => {
  ...
  test('returns default error message if fileTypeError is not provided in textOverrides', () => {
    const error: FileError = {
      code: ErrorCode.FileInvalidType,
      message: 'Invalid file type',
    }
  ...
  test('returns custom error message for file too large', () => {
    const error: FileError = {
  ...
  test('returns custom error message for invalid file type with default fileList', () => {
    const error: FileError = {
      code: ErrorCode.FileInvalidType,
      message: 'Invalid file type',
    }
  ...
  test('returns custom error message for file too large with default maxSize', () => {
    const error: FileError = {
      code: ErrorCode.FileTooLarge,
      message: 'File too large',
    }
  ...
  test('returns default error message if fileTooLargeError is not provided in textOverrides', () => {
    const error: FileError = {
      code: ErrorCode.FileTooLarge,
      message: 'File too large',
    }
  ...
  test('returns default error message for file too large with maxSize formatted', () => {
    const error: FileError = {
      code: ErrorCode.FileTooLarge,
      message: 'File too large',
    }
  ...
  test('returns default error message for invalid file type with no fileList', () => {
    const error: FileError = {
      code: ErrorCode.FileInvalidType,
      message: 'Invalid file type',
    }
  ...
  test('returns default error message if error code does not match', () => {
    const error: FileError = {
      code: 'unknown_error',
  ...
  test('returns default error message if error code does not match and no error message', () => {
