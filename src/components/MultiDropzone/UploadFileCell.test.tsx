...
test('renders correctly when uploading', () => {
  render(
    <UploadFileCell
      file={mockFile}
      uploading={true}
...
test('renders correctly when there is an error while uploading is active', () => {
  render(
    <UploadFileCell
      file={{
        ...mockFile,
...
test('calls onRemoveFile when delete button is clicked', () => {
  render(
    <UploadFileCell
      file={mockFile}
      uploading={false}
...
test('renders progress bar when showProgressBar and does not render CircularProgress with default file arguments', () => {
...
test('renders CircularProgress when showLoadingSpinner is true', () => {
...
test('renders DeleteIcon when upload is not complete and not uploading', () => {
  render(
    <UploadFileCell
      file={mockFile}
      uploading={false}
...
test('renders ErrorIcon when hasError is true', () => {
  render(
    <UploadFileCell
      file={mockFile}
      uploading={false}
